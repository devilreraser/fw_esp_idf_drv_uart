...
#define TXD0_PIN        CONFIG_ESP_UART0_TXD
#define RXD0_PIN        CONFIG_ESP_UART0_RXD
#define RTS0_PIN        CONFIG_ESP_UART0_RTS
#define CTS0_PIN        UART_PIN_NO_CHANGE

#define UART1_BAUD      9600
#define UART1_PARITY    UART_PARITY_DISABLE
#define TXD1_PIN        CONFIG_ESP_UART1_TXD
#define RXD1_PIN        CONFIG_ESP_UART1_RXD
#define RTS1_PIN        CONFIG_ESP_UART1_RTS
#define CTS1_PIN        UART_PIN_NO_CHANGE

#define UART2_BAUD      9600
#define UART2_PARITY    UART_PARITY_DISABLE
#define TXD2_PIN        CONFIG_ESP_UART2_TXD
#define RXD2_PIN        CONFIG_ESP_UART2_RXD
#define RTS2_PIN        CONFIG_ESP_UART2_RTS
